...
# To use MySQL (as specified in the tech stack), set USE_MYSQL=True in .env
# and fill in the MYSQL_* variables, then:
...
if config('USE_MYSQL', default=False, cast=bool):
    DATABASES = {
        'default': {
            ...
            'NAME': config('MYSQL_DATABASE', default='job_portal_db'),
